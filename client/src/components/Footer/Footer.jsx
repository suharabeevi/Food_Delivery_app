...
export const Footer = () => {
  return (
    <footer className="self-stretch bg-button overflow-hidden flex flex-col items-end justify-start pt-20 px-0 pb-6 box-border gap-[60px] max-w-full text-left text-xl text-text font-title-16px-regular mq750:gap-[30px_60px] mq450:pt-[52px] mq450:pb-5 mq450:box-border">
      <div className="w-[1414px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
        <div className="w-[1196px] flex flex-row items-start justify-between gap-[20px] max-w-full mq1050:flex-wrap">
          <div className="w-[217px] flex flex-col items-start justify-start gap-[16px] text-5xl font-heading-24px-bold">
            ...
            <TextField
              className="[border:none] bg-[transparent] self-stretch h-12 font-title-16px-regular text-base text-gray-300"
              placeholder="Enter your email"
              variant="outlined"
              InputProps={{
                endAdornment: (
                  <img width="24px" height="24px" src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711339055/Vector_2_b2liuq.png" />
                ),
              }}
              sx={{
                ...
                "& .MuiInputBase-input": { color: "rgba(250, 250, 250, 0.4)" },
              }}
            />
          </div>
          <div className="flex flex-col items-start justify-start gap-[24px]">
          ...
          <div className="h-[210px] w-[198px] flex flex-col items-start justify-start gap-[24px]">
            <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[24px]">
              ...
              <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[8px] text-xs text-gray-400">
                ...
                <div className="self-stretch flex-1 flex flex-row items-center justify-start gap-[8px]">
                  <img
                    ...
                    loading="lazy"
                    alt=""
                    src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711304647/Qrcode_1_l3nmrk.png"
                  />
                  <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[4px]">
                    <img
                      ...
                      loading="lazy"
                      alt=""
                      src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711304647/GooglePlay_ufvrer.png"
                    />
                    <img
                      className="self-stretch flex-1 flex flex-col items-start justify-start gap-[4px]"
                      loading="lazy"
                      alt=""
                      src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711304647/download-appstore_ydoqsr.png"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="h-6 flex flex-row items-start justify-start gap-[24px]">
              <img
                ...
                loading="lazy"
                alt=""
                src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711304647/Vector_iwipec.png"
              />
              <img
                className="h-6 w-6 relative overflow-hidden shrink-0 min-h-[24px]"
                loading="lazy"
                alt=""
                src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711304648/Group_soi12o.png"
              />
              <img
                className="h-6 w-6 relative overflow-hidden shrink-0 min-h-[24px]"
                loading="lazy"
                alt=""
                src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711304647/Group_1_lqksnw.png"
              />
              <img
                className="h-6 w-6 relative overflow-hidden shrink-0 min-h-[24px]"
                loading="lazy"
                alt=""
                src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711304647/Icon-Linkedin_tkkyw8.png"
              />
            </div>
          </div>
        </div>
        ...
        <div className="h-6 flex flex-row items-center justify-start py-0 px-5 box-border opacity-[0.6] max-w-full">
          <div className="self-stretch flex flex-row items-center justify-start gap-[6px] max-w-full">
            <img
              ...
              loading="lazy"
              alt=""
              src="https://res.cloudinary.com/dpgbodkae/image/upload/v1711339082/icon-copyright_uevhje.png"
            />
            <div className="relative leading-[24px]">
